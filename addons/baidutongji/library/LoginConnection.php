<?php
namespace addons\baidutongji\library;
...
class LoginConnection{
    ...
    public function init($url) {
        $this->url = $url;
        $this->headers = array('UUID: Fastadmin', 'account_type: 1', 'Content-Type:  data/gzencode and rsa public encrypt;charset=UTF-8');
    }
    ...
    public function genPostData($data) {
        ...
        $api_pub =  dirname(dirname(__FILE__)) . DS .'data';
        $rsa = new RsaPublicEncrypt($api_pub);
